...
public class ClientManager {
     ...
     * 每个IP最多几个链接[小于0不限制]
     */
    private final int maxConnectOneIp;

    /**
     * IP链接计数
     */
    private final Map<String, Integer> ipManage = new ConcurrentHashMap<>();
    ...
    /**
     * @param maxConnectOneIp 每个IP最多几个链接[小于0不限制]
     */
